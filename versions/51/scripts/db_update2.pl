...
my $json_data = shift @ARGV || '{"adaptor":["AnalysisJob"],"dbID":["86"],"id":["aeaoofnhgocdbnbeljkmbjdmhbcokfdb-mousedown"],"method":["add_input_id_key"],"url":["mysql://ensadmin:ensembl@127.0.0.1:2911/mm14_test_51"],"value":["jjjj"],"version":["51"]}';
#my $json_data = shift @ARGV || '{"version":["51"],"adaptor":["AnalysisJob"],"method":["status"],"url":["mysql://ensro@127.0.0.1:2911/mm14_test_51"],"value":["DONE"],"dbID":["3,9"]}'; #'{"analysis_id":["2"],"adaptor":["ResourceDescription"],"method":["parameters"],"args":["-C0 -M8000000  -R\"select[mem>8000]  rusage[mem=8000]\""],"url":["mysql://ensro@127.0.0.1:2912/mp12_compara_nctrees_69a2"]}'; #'{"url":["mysql://ensro@127.0.0.1:2912/mp12_compara_nctrees_69b"], "column_name":["parameters"], "analysis_id":["27"], "newval":["cmalign_exe"]}';
...
if (defined $dbConn) {
  ...
  for my $obj (@$objs) {
    eval {
      ...
      $obj->$method(@args);
      print STDERR "INPUT_ID: ", $obj->input_id(), "\n";
