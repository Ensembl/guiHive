...
package Bio::EnsEMBL::Hive::PipeConfig::LongMultForeign_conf;
    ...
    return [
        {   -logic_name => 'take_b_apart',
            ...
            -flow_into => {
                ...
                'A->1' => [ 'add_together'  ],
                '2' => { 'mysql://ensadmin:ensembl@127.0.0.1/lg4_long_mult_wf/analysis?logic_name=part_multiply' => { 'a_multiplier' => '#a_multiplier#', 'digit' => '#digit#', 'take_time' => '#take_time#', 'foreign' => 1 } },
                '1' => [ 'mysql://ensadmin:ensembl@127.0.0.1/lg4_long_mult_wf/analysis?logic_name=add_together' ],
            },
        },
...
#           -analysis_capacity  =>  0,  # this is a way to temporarily block a given analysis
            -wait_for => [ 'mysql://ensadmin:ensembl@127.0.0.1/lg4_long_mult_wf/analysis?logic_name=part_multiply' ],
            -flow_into => {
                1 => [ ':////final_result',
                         'mysql://ensadmin:ensembl@127.0.0.1/lg4_long_mult_wf/final_result',
                     ],
            },
        },
    ];
